...
export type UserFragmentFragment = { __typename?: 'User', id: string, name?: string | null, balance: number, username: string, raking: number, email: string, image?: string | null, createdAt?: any | null, updatedAt?: any | null };

export type CardFragmentFragment = { __typename?: 'Card', id: string, number: number, numbers: any, status: boolean, createdAt?: any | null, updatedAt?: any | null };

export type RoomFragmentFragment = { __typename?: 'Room', id: string, name: string, award: number, price: number, time: any, createdAt?: any | null, status: boolean, updatedAt?: any | null, drawnNumbers: any, users: Array<{ __typename?: 'User', id: string, name?: string | null, balance: number, username: string, raking: number, email: string, image?: string | null, createdAt?: any | null, updatedAt?: any | null }>, cards: Array<{ __typename?: 'Card', id: string, number: number, numbers: any, status: boolean, createdAt?: any | null, updatedAt?: any | null }> };
...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'AuthResponse', accessToken: string, refreshToken: string, user: { __typename?: 'User', username: string, email: string, name?: string | null, id: string } } };
...
export type RegisterMutation = { __typename?: 'Mutation', register: { __typename?: 'AuthResponse', accessToken: string, refreshToken: string, user: { __typename?: 'User', username: string, email: string, name?: string | null, id: string } } };
...
export type MutationMutation = { __typename?: 'Mutation', addUserToRoom: string };
...
export type AnnounceNumberMutation = { __typename?: 'Mutation', announceNumber?: number | null };
...
export type UpdateUserMutation = { __typename?: 'Mutation', updateUser: { __typename?: 'User', id: string, name?: string | null, balance: number, username: string, raking: number, email: string, image?: string | null, createdAt?: any | null, updatedAt?: any | null } };
...
export type ProfileQuery = { __typename?: 'Query', profile: { __typename?: 'User', id: string, name?: string | null, username: string, raking: number, balance: number, email: string, image?: string | null, refreshToken?: string | null, role?: string | null, createdAt?: any | null, updatedAt?: any | null } };
...
export type RoomStartedSubscription = { __typename?: 'Subscription', roomStarted: { __typename?: 'RoomStarted', roomId: string, message: string } };
...
export const AnnounceNumberDocument = gql`
  ...
  announceNumber(roomId: $roomId)
    ...
    `;
export type AnnounceNumberMutationFn = Apollo.MutationFunction<AnnounceNumberMutation, AnnounceNumberMutationVariables>;
 ...
 * });
 */
export function useAnnounceNumberMutation(baseOptions?: Apollo.MutationHookOptions<AnnounceNumberMutation, AnnounceNumberMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AnnounceNumberMutation, AnnounceNumberMutationVariables>(AnnounceNumberDocument, options);
      }
export type AnnounceNumberMutationHookResult = ReturnType<typeof useAnnounceNumberMutation>;
export type AnnounceNumberMutationResult = Apollo.MutationResult<AnnounceNumberMutation>;
export type AnnounceNumberMutationOptions = Apollo.BaseMutationOptions<AnnounceNumberMutation, AnnounceNumberMutationVariables>;
 ...
 * });
 */
export function useRoomStartedSubscription(baseOptions: Apollo.SubscriptionHookOptions<RoomStartedSubscription, RoomStartedSubscriptionVariables> & ({ variables: RoomStartedSubscriptionVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<RoomStartedSubscription, RoomStartedSubscriptionVariables>(RoomStartedDocument, options);
      }
export type RoomStartedSubscriptionHookResult = ReturnType<typeof useRoomStartedSubscription>;
export type RoomStartedSubscriptionResult = Apollo.SubscriptionResult<RoomStartedSubscription>;